...
async function utility_benchmark(households, maxHouseholds) {
  console.log("Starting Utility Benchmark ...");

  while (households < maxHouseholds) {
    console.log(`Deploying UtilityBenchmark Contract for ${households} Households ...`);
    ...
    console.log("UtilityBenchmark Contract Address: " + deployedContract.address);
    var start = new Date();
    await deployedContract.methods
      ...
      .estimateGas({ gas: 3061084102 }, function(error, gasAmount) {
        ...
        var end = new Date();
        data.push({ households: households, gas: gasAmount, time: end - start });
      });
