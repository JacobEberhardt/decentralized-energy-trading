...
contract dUtility is Mortal, IdUtility {
   ...
   */
  function addHousehold(address _household) external onlyOwner() override returns (bool) {
   ...
   */
  function getHousehold(address _household) external view householdExists(_household) override returns (bool, bytes32, bytes32) {
   ...
   * @return success bool if household does not already exists, should only be called by some authority
   */
  function removeHousehold(address _household) external onlyOwner() householdExists(_household) override returns (bool) {
   ...
   */
  function setVerifier(address _verifier) external onlyOwner() override returns (bool) {
   ...
   */
  function getTransfersLength() external view override returns (uint256) {
   ...
   * @return success bool if function was called successfully
   */
