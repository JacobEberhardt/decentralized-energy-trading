...
*/`
    ...
    fs.writeFile('netting-entity/dockerized_setup/docker/decentralized-energy-trading/ned-server-config.js', code2, 'utf8',(err)=> {
      if (err) throw err;
    })

    fs.writeFile('household-server/docker/decentralized-energy-trading/ned-server-config.js', code2, 'utf8',(err)=> {
      if (err) throw err;
    })
